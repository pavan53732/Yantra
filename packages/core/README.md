...
Shared engine primitives: base types, Event Bus client, configuration loading, and the runtime kernel that other packages build on.
...
Nothing above Infrastructure in the layer stack.

## Specification

The binding specification for this package will live at
`docs/specifications/core-spec.md` (or an equivalent named spec) and must be
