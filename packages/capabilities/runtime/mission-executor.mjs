...
');
  evidence.push({ id: 'fs-write', type: 'filesystem', summary: 'Wrote project source file', details);
...
');
  evidence.push({ id: 'fs-write-test', type: 'filesystem', summary: 'Wrote sample test file', details);
  ...
  evidence.push({ id: 'node-version', type: 'node', summary: 'Resolved node version', details);
  return { success;
}
